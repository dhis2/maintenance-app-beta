...
export const dataSetSections = {
    ...
    dataSetNotification: {
        ...
        description: 'Create, update, view, and delete data set notifications.',
...
export const programSections = {
    ...
    programRuleVariable: {
        ...
        description: 'Variables you use to create program rule expressions.',
...
export const validationSections = {
    ...
    validationNotification: {
        ...
        description: 'Sends a notification when a validation rule failed',
