...
import { randomLongString, testAttribute } from '../../testUtils/builders'
...
describe.skip('Attribute form tests', () => {
    ...
    describe('Common', () => {
        ...
        it.only('should show an error if name field is too long', async () => {
